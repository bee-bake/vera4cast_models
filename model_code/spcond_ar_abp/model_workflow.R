...
helper.functions <- list.files("./R/spcond_ar_abp")
sapply(paste0("./R/spcond_ar_abp/", helper.functions),source,.GlobalEnv)
...
project_id <- "vera4cast"
  ...
  forecast_file_abs_path <- paste0("./model_output/spcond_ar_abp/", model_id, "_", site, "_", forecast_date, ".csv")
